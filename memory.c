...
struct MEMORY_BLOCK best_fit_allocate(int request_size, struct MEMORY_BLOCK memory_map[MAPMAX], int * map_cnt, int process_id)
{
    ...
    if(best_idx != -1)
    {
        ...
        *map_cnt += 1;
        ...
        printf("map_cnt: %d\n", *map_cnt);
        printf("MB: %d%d%d%d\n", memory_map[best_idx].start_address,memory_map[best_idx].end_address,memory_map[best_idx].segment_size,memory_map[best_idx].process_id);
...
struct MEMORY_BLOCK first_fit_allocate(int request_size, struct MEMORY_BLOCK memory_map[MAPMAX], int * map_cnt, int process_id)
{
    ...
    if(lowest_starting_address != -1)
    {
        ...
        *map_cnt += 1;
        ...
        printf("map_cnt: %d\n", *map_cnt);
        printf("MB: %d%d%d%d\n", memory_map[lowest_starting_address].start_address,memory_map[lowest_starting_address].end_address,memory_map[lowest_starting_address].segment_size,memory_map[lowest_starting_address].process_id);
...
struct MEMORY_BLOCK worst_fit_allocate(int request_size, struct MEMORY_BLOCK memory_map[MAPMAX], int * map_cnt, int process_id)
{
    ...
    if(largest_block_idx != -1)
    {
        ...
        *map_cnt += 1;
        ...
        printf("map_cnt: %d\n", *map_cnt);
        printf("MB: %d%d%d%d\n", memory_map[largest_block_idx].start_address,memory_map[largest_block_idx].end_address,memory_map[largest_block_idx].segment_size,memory_map[largest_block_idx].process_id);
...
int main()
{
    struct MEMORY_BLOCK mm[MAPMAX] = {{0,7,8,12},{8,15,8,0},{16,23,8,13},{24,27,4,0},{28,29,2,11}};
    struct MEMORY_BLOCK fb = {16,23,8,13};
    int mc = 5;
